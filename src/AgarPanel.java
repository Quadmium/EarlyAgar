    ...
    public void paintComponent(Graphics g)
    {
        ...
        else
        {
            ...
            synchronized(LOCK)
            {
                ...
                int chatOffset = 30;
                for(int i=chatData.size() - 1; i >= 0; i--)
                {
                    g.setColor(Color.BLACK);
                    g.drawString(chatData.get(i), 5, d.height - chatOffset);
                    chatOffset += 10;
                }
                ...
                if(typing)
                {
                    ...
                    g.fillRect(0, d.height - 20, 250, 20);
                    g.setColor(Color.BLACK);
                    g.drawString(inProgressChat, 5, d.height - 5);
                }
            }
        }
    }
